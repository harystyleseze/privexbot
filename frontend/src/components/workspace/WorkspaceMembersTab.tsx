        ...
        <div className="space-y-3">
          {!showAddMember ? (
            ...
            <form onSubmit={handleSubmit(handleSendInvitation)} className="bg-[#2B2D31] rounded-lg p-4 space-y-3">
              ...
              <div>
                <label htmlFor="add-member-email" className="block text-xs font-bold text-gray-300 uppercase mb-2">
              ...
              <div>
                <label htmlFor="add-member-role" className="block text-xs font-bold text-gray-300 uppercase mb-2">
                  Role
                </label>
                <select
                  id="add-member-role"
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <Badge className="bg-yellow-500 text-white text-xs capitalize">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <Button
                    ...
                    className="text-red-400 hover:text-red-500 hover:border-red-500"
